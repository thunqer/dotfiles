;;; ../dotfiles/.doom.d/doom-tokyo-storm-theme.el -*- lexical-binding: t; -*-

(require 'doom-themes)

;;
(defgroup doom-tokyo-storm-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-tokyo-storm-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-tokyo-storm-theme
  :type 'boolean)

(defcustom doom-tokyo-storm-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-tokyo-storm-theme
  :type 'boolean)

(defcustom doom-tokyo-storm-comment-bg doom-tokyo-storm-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'doom-tokyo-storm-theme
  :type 'boolean)

(defcustom doom-tokyo-storm-padded-modeline nil
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to determine the exact padding."
  :group 'doom-tokyo-storm-theme
  :type '(or integer boolean))

(def-doom-theme doom-tokyo-storm
  "A clean, dark theme that celebrates the lights of downtown Tokyo at storm."
  ...
  ((bg         '("#24283b" nil       nil            ))
   ...
   (selection      base0)
   (builtin        red)
   (comments       (if doom-tokyo-storm-brighter-comments base5 base1))
   (doc-comments   (doom-lighten (if doom-tokyo-storm-brighter-comments base5 base1) 0.25))
   (constants      orange)
   (functions      blue)
   (keywords       green)
   (methods        blue)
   ...
   (-modeline-bright doom-tokyo-storm-brighter-modeline)
   (-modeline-pad
    (when doom-tokyo-storm-padded-modeline
      (if (integerp doom-tokyo-storm-padded-modeline) doom-tokyo-storm-padded-modeline 4)))
  ...
  (
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-tokyo-storm-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
...
;;; doom-tokyo-storm-theme.el ends here
